...
#define mCPLDADDR_DA2_Convert_Sync (mCPLD_BASE+0x994) //0x994 DA convert
#define mCPLDADDR_DA2_CS (mCPLD_BASE+0x998) //0x998	DA convert CS
...
//0xA28	DA convert Max Voltage2
//0xA2C		DA convert Start Voltage 2
...
extern union SERVO_COM_READSIGN_REG	Servo_Com_ReadSign_Register2;
...
extern volatile INT16U * READ_COM_ReadSign2;
...
extern  AD5315DA  Ad_Convert_2_Sync;
...
extern volatile INT16U * DA_Convert_Ctrl_2_Sync;
...
extern void Read_Serial_Com_ReadSign2(void);
...
extern void Write_DA_CONVERT_CONTROL_PC(void);
extern void Write_DA_CONVERT_CONTROL_PC_CAL(Uint8 Cal_Modle_Sel);
