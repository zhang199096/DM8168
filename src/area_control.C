...
Uint16 CompensationCnt = 0 ;  //add by chabu
...
{		
	...
	else if(ModuleSel == 11)
	{
		...
		if(AREAControl->Stotal_Module.Module11 > 0.000001)
		{
			...
			AREAControl->Vs_Module.Module11 = 3;//3mm/s	
			AREAControl->Ve_Module.Module11 = 3;//3mm/s	
			...
			AREAControl->VmReal_Module.Module11 = 3;//3mm/s		
			AREAControl->DeltaT1_Module.Module11 = 0;
			AREAControl->DeltaT2_Module.Module11 = 0;	
			AREAControl->DeltaT3_Module.Module11 = divdp( AREAControl->Stotal_Module.Module11 , 3);
...
Uint16 NCAreaCalNowValue(AREA_CONTROL *AREAControl, GCODE *AreaGcodeBufferPointer, NC_RUN_SIGN *AreaRunNCSign,Uint8 ModuleSel)
{
	...
	static Int32		LensMotionMaxOffset = 20;
	...
	{		
		...
		{	//第一种情况:已到达区域终点
				...
				)
			{
				...
				if(fabs(AREAControl->I) < AREAControl->TotalN_Module.Module11)
				{
					OverallSign.LensMotionOverSign = OverallSign.LensMotionOverSign;
					OverallSign.LensMotionOverSign = LensMotionNormal;
					return 0;
...
{	//FPGA_B
	...
	{	
			...
			)
		{
			...
			IRQ_ENABLE(IRQNUM_PLUSE3);		
			IRQ_ENABLE(IRQNUM_PLUSE4);		
			//*(GPIO_IRQStatus.GPIO1_IRQStatus_1) = (0x1<<22);			//old set value 	//GPIO1_1	int67 reserved gpio1_1 pin=gpio1_1_bit19;DSP  INT 67
			//*(GPIO_IRQStatus.GPIO1_IRQStatus_RAW_1) = (0x1<<22);		//old set value	//GPIO1_1	int67 reserved gpio1_1 pin=gpio1_1_bit19;DSP  INT 67
			//*(GPIO_IRQStatus.GPIO1_IRQStatus_1) = (0x1<<19);			//20170522new	//GPIO1_1	int67 reserved gpio1_1 pin=gpio1_1_bit19;DSP  INT 67
			//*(GPIO_IRQStatus.GPIO1_IRQStatus_RAW_1) = (0x1<<19);		//20170522new	//GPIO1_1	int67 reserved gpio1_1 pin=gpio1_1_bit19;DSP  INT 67
			*(GPIO_IRQStatus.GPIO1_IRQStatus_0) = (0x1<<17);		//GPIO1_0	//int66 pulse_interpolation gpio1_0 pin=gpio1_0_bit17;DSP  INT 66
			*(GPIO_IRQStatus.GPIO1_IRQStatus_RAW_0) = (0x1<<17);	//GPIO1_0	//int66 pulse_interpolation gpio1_0 pin=gpio1_0_bit17;DSP  INT 66
			return 0;
		}
	}
		...
		(OverallSign.LensMotionOverSign == LensMotionCompensationRun))
	{
		...
		*(Servo_Axis6.PWM_Port) = 10;
		*(Servo_Axis7.PWM_Port) = 10;
		*(Servo_Axis8.PWM_Port) = 10;
		*(Servo_Axis9.PWM_Port) = 10;
		*(Servo_Axis10.PWM_Port) = 10;
		*(Servo_Axis19.PWM_Port) = 10;
		*(Servo_Axis20.PWM_Port) = 10;
		*(Servo_Axis21.PWM_Port) = 10;
		*(Servo_Axis22.PWM_Port) = 10;		
	}
	else
	{
...
{	//FPGA_A
	...
	{			
		...
		IRQ_ENABLE(IRQNUM_PLUSE3);		
		IRQ_ENABLE(IRQNUM_PLUSE4);
		//*(GPIO_IRQStatus.GPIO0_IRQStatus_0) = (0x1<<23);			//old set value	//GPIO0_0 int64   reserved  gpio0 pin=gpio0_bit24;DSP  INT 64
		//*(GPIO_IRQStatus.GPIO0_IRQStatus_RAW_0) = (0x1<<23);		//old set value	//GPIO0_0 int64   reserved  gpio0 pin=gpio0_bit24;DSP  INT 64
		//*(GPIO_IRQStatus.GPIO0_IRQStatus_0) = (0x1<<24);			//20170522	//GPIO0_0 int64   reserved  gpio0 pin=gpio0_bit24;DSP  INT 64
		//*(GPIO_IRQStatus.GPIO0_IRQStatus_RAW_0) = (0x1<<24);		//20170522	//GPIO0_0 int64   reserved  gpio0 pin=gpio0_bit24;DSP  INT 64
...
Uint16  NCAreaRun(AREA_CONTROL *AREAControl, GCODE *AreaGcodeBufferPointer, NC_RUN_SIGN *AreaRunNCSign)
{
	...
	Int8	ReturnValue,ReturnValue_Temp;
	ReturnValue = 0;
	...
	else if((ReturnValue == 11)&&(ReturnValue_Temp == 1))
	{
		if(OverallSign.LensMotionOverSign == LensMotionCompensationRun)
		{
			return;
