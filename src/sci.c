...
Uint32 SCIB_TxBuf[4096];	
Uint32 SCIB_RxBuf[4096];	

Uint8 STM32_TxBuf[4096];
Uint8 STM32_RxBuf[4096];

Uint32 STM32_TxIndex;
Uint32 STM32_TxTotal;
Uint32 STM32_RxIndex;
Uint32 STM32_RxTotal;

Uint32 STM32_TxRXCounter;
Uint32 STM32_RXCounter;
...
Uint16 DSP_com_STM32_MainCMD_B0(void)
{

}

Uint16 Dsp_Com_STM32_BackCMD_B0(void)
{
	Uint32	*SendUUint32Pointer1;
	Uint32 data32;
	Uint32 CheckCode;
	Uint32 length_B0Back;

	length_B0Back = 130;

	SendUUint32Pointer1 = SCIB_TxBuf;
	*SendUUint32Pointer1++ = 0xaa;				//START
	*SendUUint32Pointer1++ = length_B0Back ;
	*SendUUint32Pointer1++ = 0xcc;				//
	*SendUUint32Pointer1++ = 250;	//192.168.1.250			
	*SendUUint32Pointer1++ = 0x0f;				//
	*SendUUint32Pointer1++ = 0xb0;				//
	*SendUUint32Pointer1++ = 0x01;				//

	//INFOR14-INFOR17	°æ±¾ÈÕÆÚ·µ»Ø25-28
	*SendUUint32Pointer1++ = 2017;	//Äê	2017
	*SendUUint32Pointer1++ = 4;	//ÔÂ
	*SendUUint32Pointer1++ = 19;	//ÈÕ
	*SendUUint32Pointer1++ = 0x03;	//°æ±¾ V3.0.3
	*SendUUint32Pointer1++ = psDSPPacketOut_InfoEvent->NCModeType;

	*SendUUint32Pointer1++ = psDSPPacketOut->STDRunCount;
	*SendUUint32Pointer1++ = psDSPPacketOut->SPCRunCount;
	*SendUUint32Pointer1++ = psDSPPacketOut->STDSendCount;//
	*SendUUint32Pointer1++ = psDSPPacketOut->SPCSendCount;//
	*SendUUint32Pointer1++ = psDSPPacketOut->MicroEDataBaseStartCnt;

	*SendUUint32Pointer1++ = psDSPPacketOut->FeedSet;//11
	*SendUUint32Pointer1++ = psDSPPacketOut->FeedReal.Module1;
	*SendUUint32Pointer1++ = psDSPPacketOut->FeedReal.Module8;
	*SendUUint32Pointer1++ = psDSPPacketOut->FeedReal.Module3;
	*SendUUint32Pointer1++ = psDSPPacketOut->FeedReal.Module3;
	*SendUUint32Pointer1++ = psDSPPacketOut->FeedReal.Module3;
	*SendUUint32Pointer1++ = psDSPPacketOut->FeedReal.Module5;
	*SendUUint32Pointer1++ = psDSPPacketOut->FeedReal.Module4;
	*SendUUint32Pointer1++ = psDSPPacketOut->FeedReal.Module4;
	*SendUUint32Pointer1++ = psDSPPacketOut->FeedReal.Module7;
	*SendUUint32Pointer1++ = psDSPPacketOut->FeedReal.Module7;
	*SendUUint32Pointer1++ = psDSPPacketOut->FeedReal.Module6;
	*SendUUint32Pointer1++ = psDSPPacketOut->FeedReal.Module6;
	*SendUUint32Pointer1++ = psDSPPacketOut->FeedReal.Module10;
	*SendUUint32Pointer1++ = psDSPPacketOut->FeedReal.Module10;
	*SendUUint32Pointer1++ = psDSPPacketOut->FeedReal.Module1;

	*SendUUint32Pointer1++ = psDSPPacketOut->FeedReal.Module1;
	*SendUUint32Pointer1++ = psDSPPacketOut->FeedReal.Module2;
	*SendUUint32Pointer1++ = psDSPPacketOut->FeedReal.Module2;
	*SendUUint32Pointer1++ = psDSPPacketOut->FeedReal.Module11;
	*SendUUint32Pointer1++ = psDSPPacketOut->FeedReal.Module5;

	*SendUUint32Pointer1++ = psDSPPacketOut->FeedReal.Module7;
	*SendUUint32Pointer1++ = psDSPPacketOut->FeedReal.Module9;
	*SendUUint32Pointer1++ = psDSPPacketOut->FeedReal.Module12;
	*SendUUint32Pointer1++ = 0;
	*SendUUint32Pointer1++ = 0;
	//for test
	//psDSPPacketOut->MachineCoordinateAxis1 = 123456;
	//psDSPPacketOut->MachineCoordinateAxis2 = 234567;
	//psDSPPacketOut->MachineCoordinateAxis3 = 345678;
	//psDSPPacketOut->MachineCoordinateAxis4 = 456789;
	*SendUUint32Pointer1++ = psDSPPacketOut->ABSMachineCoordinateAxis1;
	*SendUUint32Pointer1++ = psDSPPacketOut->ABSMachineCoordinateAxis2;
	*SendUUint32Pointer1++ = psDSPPacketOut->ABSMachineCoordinateAxis3;
	*SendUUint32Pointer1++ = psDSPPacketOut->ABSMachineCoordinateAxis4;
	*SendUUint32Pointer1++ = psDSPPacketOut->ABSMachineCoordinateAxis5;
	*SendUUint32Pointer1++ = psDSPPacketOut->ABSMachineCoordinateAxis6;
	*SendUUint32Pointer1++ = psDSPPacketOut->ABSMachineCoordinateAxis7;
	*SendUUint32Pointer1++ = psDSPPacketOut->ABSMachineCoordinateAxis8;
	*SendUUint32Pointer1++ = psDSPPacketOut->ABSMachineCoordinateAxis9;
	*SendUUint32Pointer1++ = psDSPPacketOut->ABSMachineCoordinateAxis10;
	*SendUUint32Pointer1++ = psDSPPacketOut->ABSMachineCoordinateAxis11;
	*SendUUint32Pointer1++ = psDSPPacketOut->ABSMachineCoordinateAxis12;
	*SendUUint32Pointer1++ = psDSPPacketOut->ABSMachineCoordinateAxis13;
	*SendUUint32Pointer1++ = psDSPPacketOut->ABSMachineCoordinateAxis14;
	*SendUUint32Pointer1++ = psDSPPacketOut->ABSMachineCoordinateAxis15;
	*SendUUint32Pointer1++ = psDSPPacketOut->ABSMachineCoordinateAxis16;
	*SendUUint32Pointer1++ = psDSPPacketOut->ABSMachineCoordinateAxis17;
	*SendUUint32Pointer1++ = psDSPPacketOut->ABSMachineCoordinateAxis18;
	*SendUUint32Pointer1++ = psDSPPacketOut->ABSMachineCoordinateAxis19;
	*SendUUint32Pointer1++ = psDSPPacketOut->ABSMachineCoordinateAxis20;
	*SendUUint32Pointer1++ = psDSPPacketOut->ABSMachineCoordinateAxis21;
	*SendUUint32Pointer1++ = psDSPPacketOut->ABSMachineCoordinateAxis22;
	*SendUUint32Pointer1++ = psDSPPacketOut->ABSMachineCoordinateAxis23;
	*SendUUint32Pointer1++ = psDSPPacketOut->ABSMachineCoordinateAxis24;
	*SendUUint32Pointer1++ = psDSPPacketOut->ABSMachineCoordinateAxis25;

	*SendUUint32Pointer1++ = psDSPPacketOut->MachineCoordinateAxis1;
	*SendUUint32Pointer1++ = psDSPPacketOut->MachineCoordinateAxis2;
	*SendUUint32Pointer1++ = psDSPPacketOut->MachineCoordinateAxis3;
	*SendUUint32Pointer1++ = psDSPPacketOut->MachineCoordinateAxis4;
	*SendUUint32Pointer1++ = psDSPPacketOut->MachineCoordinateAxis5;
	*SendUUint32Pointer1++ = psDSPPacketOut->MachineCoordinateAxis6;
	*SendUUint32Pointer1++ = psDSPPacketOut->MachineCoordinateAxis7;
	*SendUUint32Pointer1++ = psDSPPacketOut->MachineCoordinateAxis8;
	*SendUUint32Pointer1++ = psDSPPacketOut->MachineCoordinateAxis9;
	*SendUUint32Pointer1++ = psDSPPacketOut->MachineCoordinateAxis10;
	*SendUUint32Pointer1++ = psDSPPacketOut->MachineCoordinateAxis11;
	*SendUUint32Pointer1++ = psDSPPacketOut->MachineCoordinateAxis12;
	*SendUUint32Pointer1++ = psDSPPacketOut->MachineCoordinateAxis13;
	*SendUUint32Pointer1++ = psDSPPacketOut->MachineCoordinateAxis14;
	*SendUUint32Pointer1++ = psDSPPacketOut->MachineCoordinateAxis15;
	*SendUUint32Pointer1++ = psDSPPacketOut->MachineCoordinateAxis16;
	*SendUUint32Pointer1++ = psDSPPacketOut->MachineCoordinateAxis17;
	*SendUUint32Pointer1++ = psDSPPacketOut->MachineCoordinateAxis18;
	*SendUUint32Pointer1++ = psDSPPacketOut->MachineCoordinateAxis19;
	*SendUUint32Pointer1++ = psDSPPacketOut->MachineCoordinateAxis20;
	*SendUUint32Pointer1++ = psDSPPacketOut->MachineCoordinateAxis21;
	*SendUUint32Pointer1++ = psDSPPacketOut->MachineCoordinateAxis22;
	*SendUUint32Pointer1++ = psDSPPacketOut->MachineCoordinateAxis23;
	*SendUUint32Pointer1++ = psDSPPacketOut->MachineCoordinateAxis24;
	*SendUUint32Pointer1++ = psDSPPacketOut->MachineCoordinateAxis25;

	*SendUUint32Pointer1++ = psDSPPacketOut_InfoEvent->SPCSendEnable;
	*SendUUint32Pointer1++ = psDSPPacketOut_InfoEvent->STDSendEnable;
	*SendUUint32Pointer1++ = psDSPPacketOut_InfoEvent->DSPInAlarm;
	*SendUUint32Pointer1++ = psDSPPacketOut_InfoEvent->DSPLocateOver;
	*SendUUint32Pointer1++ = psDSPPacketOut_InfoEvent->DSPRunOver;

	*SendUUint32Pointer1++ = psDSPPacketOut_InfoEvent->ParameterWriteCompleteSign;

	data32 = 0;
	//data32 = 0xAAAAAAAA;//for test
	if(psDSPPacketOut_InfoEvent->HLimitPosAxis1==1) data32 |= 0x01;
	if(psDSPPacketOut_InfoEvent->HLimitPosAxis2==1) data32 |= 0x02;
	if(psDSPPacketOut_InfoEvent->HLimitPosAxis3==1) data32 |= 0x04;
	if(psDSPPacketOut_InfoEvent->HLimitPosAxis4==1) data32 |= 0x08;
	if(psDSPPacketOut_InfoEvent->HLimitPosAxis5==1) data32 |= 0x010;

	if(psDSPPacketOut_InfoEvent->HLimitPosAxis6==1) data32 |= 0x020;
	if(psDSPPacketOut_InfoEvent->HLimitPosAxis7==1) data32 |= 0x040;
	if(psDSPPacketOut_InfoEvent->HLimitPosAxis8==1) data32 |= 0x080;
	if(psDSPPacketOut_InfoEvent->HLimitPosAxis9==1) data32 |= 0x0100;
	if(psDSPPacketOut_InfoEvent->HLimitPosAxis10==1) data32 |= 0x0200;

	if(psDSPPacketOut_InfoEvent->HLimitPosAxis11==1) data32 |= 0x0400;
	if(psDSPPacketOut_InfoEvent->HLimitPosAxis12==1) data32 |= 0x0800;
	if(psDSPPacketOut_InfoEvent->HLimitPosAxis13==1) data32 |= 0x01000;
	if(psDSPPacketOut_InfoEvent->HLimitPosAxis14==1) data32 |= 0x02000;
	if(psDSPPacketOut_InfoEvent->HLimitPosAxis15==1) data32 |= 0x04000;

	if(psDSPPacketOut_InfoEvent->HLimitPosAxis16==1) data32 |= 0x08000;
	if(psDSPPacketOut_InfoEvent->HLimitPosAxis17==1) data32 |= 0x010000;
	if(psDSPPacketOut_InfoEvent->HLimitPosAxis18==1) data32 |= 0x020000;
	if(psDSPPacketOut_InfoEvent->HLimitPosAxis19==1) data32 |= 0x040000;
	if(psDSPPacketOut_InfoEvent->HLimitPosAxis20==1) data32 |= 0x080000;

	if(psDSPPacketOut_InfoEvent->HLimitPosAxis21==1) data32 |= 0x0100000;
	if(psDSPPacketOut_InfoEvent->HLimitPosAxis22==1) data32 |= 0x0200000;
	if(psDSPPacketOut_InfoEvent->HLimitPosAxis23==1) data32 |= 0x0400000;
	*SendUUint32Pointer1++ = data32;

	data32 = 0;
	//data32 = 0xBBBBBBBB;//for test
	if(psDSPPacketOut_InfoEvent->HLimitNegAxis1==1) data32 |= 0x01;
	if(psDSPPacketOut_InfoEvent->HLimitNegAxis2==1) data32 |= 0x02;
	if(psDSPPacketOut_InfoEvent->HLimitNegAxis3==1) data32 |= 0x04;
	if(psDSPPacketOut_InfoEvent->HLimitNegAxis4==1) data32 |= 0x08;
	if(psDSPPacketOut_InfoEvent->HLimitNegAxis5==1) data32 |= 0x010;

	if(psDSPPacketOut_InfoEvent->HLimitNegAxis6==1) data32 |= 0x020;
	if(psDSPPacketOut_InfoEvent->HLimitNegAxis7==1) data32 |= 0x040;
	if(psDSPPacketOut_InfoEvent->HLimitNegAxis8==1) data32 |= 0x080;
	if(psDSPPacketOut_InfoEvent->HLimitNegAxis9==1) data32 |= 0x0100;
	if(psDSPPacketOut_InfoEvent->HLimitNegAxis10==1) data32 |= 0x0200;

	if(psDSPPacketOut_InfoEvent->HLimitNegAxis11==1) data32 |= 0x0400;
	if(psDSPPacketOut_InfoEvent->HLimitNegAxis12==1) data32 |= 0x0800;
	if(psDSPPacketOut_InfoEvent->HLimitNegAxis13==1) data32 |= 0x01000;
	if(psDSPPacketOut_InfoEvent->HLimitNegAxis14==1) data32 |= 0x02000;
	if(psDSPPacketOut_InfoEvent->HLimitNegAxis15==1) data32 |= 0x04000;

	if(psDSPPacketOut_InfoEvent->HLimitNegAxis16==1) data32 |= 0x08000;
	if(psDSPPacketOut_InfoEvent->HLimitNegAxis17==1) data32 |= 0x010000;
	if(psDSPPacketOut_InfoEvent->HLimitNegAxis18==1) data32 |= 0x020000;
	if(psDSPPacketOut_InfoEvent->HLimitNegAxis19==1) data32 |= 0x040000;
	if(psDSPPacketOut_InfoEvent->HLimitNegAxis20==1) data32 |= 0x080000;

	if(psDSPPacketOut_InfoEvent->HLimitNegAxis21==1) data32 |= 0x0100000;
	if(psDSPPacketOut_InfoEvent->HLimitNegAxis22==1) data32 |= 0x0200000;
	if(psDSPPacketOut_InfoEvent->HLimitNegAxis23==1) data32 |= 0x0400000;
	*SendUUint32Pointer1++ = data32;

	data32 = 0;
	//data32 = 0xCCCCCCCC;//for test
	if(psDSPPacketOut_InfoEvent->AxisRunOverAxis1==1) data32 |= 0x01;
	if(psDSPPacketOut_InfoEvent->AxisRunOverAxis2==1) data32 |= 0x02;
	if(psDSPPacketOut_InfoEvent->AxisRunOverAxis3==1) data32 |= 0x04;
	if(psDSPPacketOut_InfoEvent->AxisRunOverAxis4==1) data32 |= 0x08;
	if(psDSPPacketOut_InfoEvent->AxisRunOverAxis5==1) data32 |= 0x010;

	if(psDSPPacketOut_InfoEvent->AxisRunOverAxis6==1) data32 |= 0x020;
	if(psDSPPacketOut_InfoEvent->AxisRunOverAxis7==1) data32 |= 0x040;
	if(psDSPPacketOut_InfoEvent->AxisRunOverAxis8==1) data32 |= 0x080;
	if(psDSPPacketOut_InfoEvent->AxisRunOverAxis9==1) data32 |= 0x0100;
	if(psDSPPacketOut_InfoEvent->AxisRunOverAxis10==1) data32 |= 0x0200;

	if(psDSPPacketOut_InfoEvent->AxisRunOverAxis11==1) data32 |= 0x0400;
	if(psDSPPacketOut_InfoEvent->AxisRunOverAxis12==1) data32 |= 0x0800;
	if(psDSPPacketOut_InfoEvent->AxisRunOverAxis13==1) data32 |= 0x01000;
	if(psDSPPacketOut_InfoEvent->AxisRunOverAxis14==1) data32 |= 0x02000;
	if(psDSPPacketOut_InfoEvent->AxisRunOverAxis15==1) data32 |= 0x04000;

	if(psDSPPacketOut_InfoEvent->AxisRunOverAxis16==1) data32 |= 0x08000;
	if(psDSPPacketOut_InfoEvent->AxisRunOverAxis17==1) data32 |= 0x010000;
	if(psDSPPacketOut_InfoEvent->AxisRunOverAxis18==1) data32 |= 0x020000;
	if(psDSPPacketOut_InfoEvent->AxisRunOverAxis19==1) data32 |= 0x040000;
	if(psDSPPacketOut_InfoEvent->AxisRunOverAxis20==1) data32 |= 0x080000;

	if(psDSPPacketOut_InfoEvent->AxisRunOverAxis21==1) data32 |= 0x0100000;
	if(psDSPPacketOut_InfoEvent->AxisRunOverAxis22==1) data32 |= 0x0200000;
	if(psDSPPacketOut_InfoEvent->AxisRunOverAxis23==1) data32 |= 0x0400000;
	if(psDSPPacketOut_InfoEvent->AxisRunOverValid1==1) data32 |= 0x8000000;
	 if(psDSPPacketOut_InfoEvent->AxisRunOverValid2==1) data32 |= 0x10000000;
	 if(psDSPPacketOut_InfoEvent->AxisRunOverValid3==1) data32 |= 0x20000000;
	 if(psDSPPacketOut_InfoEvent->AxisRunOverValid4==1) data32 |= 0x40000000;
	 if(psDSPPacketOut_InfoEvent->AxisRunOverValidAll==1) data32 |= 0x80000000;
	 *SendUUint32Pointer1++ = data32;


	data32 = 0;
	//data32 = 0xDDDDDDDD;//for test
	if(psDSPPacketOut_InfoEvent->AxisRefOverAxis1==1) data32 |= 0x01;
	if(psDSPPacketOut_InfoEvent->AxisRefOverAxis2==1) data32 |= 0x02;
	if(psDSPPacketOut_InfoEvent->AxisRefOverAxis3==1) data32 |= 0x04;
	if(psDSPPacketOut_InfoEvent->AxisRefOverAxis4==1) data32 |= 0x08;
	if(psDSPPacketOut_InfoEvent->AxisRefOverAxis5==1) data32 |= 0x010;

	if(psDSPPacketOut_InfoEvent->AxisRefOverAxis6==1) data32 |= 0x020;
	if(psDSPPacketOut_InfoEvent->AxisRefOverAxis7==1) data32 |= 0x040;
	if(psDSPPacketOut_InfoEvent->AxisRefOverAxis8==1) data32 |= 0x080;
	if(psDSPPacketOut_InfoEvent->AxisRefOverAxis9==1) data32 |= 0x0100;
	if(psDSPPacketOut_InfoEvent->AxisRefOverAxis10==1) data32 |= 0x0200;

	if(psDSPPacketOut_InfoEvent->AxisRefOverAxis11==1) data32 |= 0x0400;
	if(psDSPPacketOut_InfoEvent->AxisRefOverAxis12==1) data32 |= 0x0800;
	if(psDSPPacketOut_InfoEvent->AxisRefOverAxis13==1) data32 |= 0x01000;
	if(psDSPPacketOut_InfoEvent->AxisRefOverAxis14==1) data32 |= 0x02000;
	if(psDSPPacketOut_InfoEvent->AxisRefOverAxis15==1) data32 |= 0x04000;

	if(psDSPPacketOut_InfoEvent->AxisRefOverAxis16==1) data32 |= 0x08000;
	if(psDSPPacketOut_InfoEvent->AxisRefOverAxis17==1) data32 |= 0x010000;
	if(psDSPPacketOut_InfoEvent->AxisRefOverAxis18==1) data32 |= 0x020000;
	if(psDSPPacketOut_InfoEvent->AxisRefOverAxis19==1) data32 |= 0x040000;
	if(psDSPPacketOut_InfoEvent->AxisRefOverAxis20==1) data32 |= 0x080000;

	if(psDSPPacketOut_InfoEvent->AxisRefOverAxis21==1) data32 |= 0x0100000;
	if(psDSPPacketOut_InfoEvent->AxisRefOverAxis22==1) data32 |= 0x0200000;
	if(psDSPPacketOut_InfoEvent->AxisRefOverAxis23==1) data32 |= 0x0400000;
	if(psDSPPacketOut_InfoEvent->AxisRefOverValidAll==1) data32 |= 0x80000000;
	*SendUUint32Pointer1++ = data32;

	data32 = 0;
	//for test
	//psDSPPacketOut_InfoEvent->AlmDSPRamIn = 1;
	if(psDSPPacketOut_InfoEvent->AlmDSPRamIn)
	{
		data32 |= 0x0001;		//BIT3	DSPÐ¾Æ¬ÄÚ²¿RAM¼ìÑé³ö´í±¨¾¯			1: ±¨¾¯ÓÐÐ§
	}
	if(psDSPPacketOut_InfoEvent->AlmDSPRamOut)
	{
		data32 |= 0x0002;		//BIT4	DSPÐ¾Æ¬Íâ²¿RAM¼ìÑé³ö´í±¨¾¯			1: ±¨¾¯ÓÐÐ§
	}
	if(psDSPPacketOut_InfoEvent->AlmDSPCode)
	{
		data32 |= 0x0004;		//BIT0	ARMÏòDSP·¢ËÍ´úÂë²»Á¬Ðø±¨¾¯1: ±¨¾¯ÓÐÐ§
	}
	if(psDSPPacketOut_InfoEvent->AlmDSPTrack)
	{
		data32 |= 0x0008;		//BIT2	DSP¹ì¼£³¬³Ì±¨¾¯ 			1: ±¨¾¯ÓÐÐ§
	}
	if(psDSPPacketOut_InfoEvent->AlmDSPInterpolate)
	{
		data32 |= 0x0010;		//BIT3	DSP²å²¹Á¿¹ý´ó±¨¾¯		1: ±¨¾¯ÓÐÐ§
	}
	if(psDSPPacketOut_InfoEvent->AlmHLimitPos)
	{
		data32 |= 0x0020;		//BIT3	 AlmHLimitPos		1: ±¨¾¯ÓÐÐ§
	}
	if(psDSPPacketOut_InfoEvent->AlmHLimitNeg)
	{
		data32 |= 0x0040;		//BIT3	AlmHLimitNeg		1: ±¨¾¯ÓÐÐ§
	}
	if(psDSPPacketOut_InfoEvent->AlmSLimitPos)
	{
		data32 |= 0x0080;		//BIT3	AlmSLimitPos		1: ±¨¾¯ÓÐÐ§
	}
	if(psDSPPacketOut_InfoEvent->AlmSLimitNeg)
	{
		data32 |= 0x0100;		//BIT3	AlmSLimitNeg		1: ±¨¾¯ÓÐÐ§
	}
	if(psDSPPacketOut_InfoEvent->AlmCompDataCheck)
	{
		data32 |= 0x0200;		//BIT3	AlmCompDataCheck		1: ±¨¾¯ÓÐÐ§
	}
	if(psDSPPacketOut_InfoEvent->AlmOpticalFlashTriggerBreak)
	{
		data32 |= 0x0400;		//BIT3	AlmOpticalFlashTriggerBreak 		1: ±¨¾¯ÓÐÐ§
	}
	if(psDSPPacketOut_InfoEvent->AlmCameraShutterTriggerBreak)
	{
		data32 |= 0x0800;		//BIT3	AlmCameraShutterTriggerBreak		1: ±¨¾¯ÓÐÐ§
	}
	if(psDSPPacketOut_InfoEvent->AlmLensPositionBreak)
	{
		data32 |= 0x1000;		//BIT3	AlmLensPositionBreak		1: ±¨¾¯ÓÐÐ§
	}
	...
	*SendUUint32Pointer1++ = data32;
	...
	data32 = 0;
	//data32 = 0xEEEEEEEE;//for test
	if(psDSPPacketOut_InfoEvent->AlmServoAxis1==1) data32 |= 0x01;
	if(psDSPPacketOut_InfoEvent->AlmServoAxis2==1) data32 |= 0x02;
	if(psDSPPacketOut_InfoEvent->AlmServoAxis3==1) data32 |= 0x04;
	if(psDSPPacketOut_InfoEvent->AlmServoAxis4==1) data32 |= 0x08;
	if(psDSPPacketOut_InfoEvent->AlmServoAxis5==1) data32 |= 0x010;

	if(psDSPPacketOut_InfoEvent->AlmServoAxis6==1) data32 |= 0x020;
	if(psDSPPacketOut_InfoEvent->AlmServoAxis7==1) data32 |= 0x040;
	if(psDSPPacketOut_InfoEvent->AlmServoAxis8==1) data32 |= 0x080;
	if(psDSPPacketOut_InfoEvent->AlmServoAxis9==1) data32 |= 0x0100;
	if(psDSPPacketOut_InfoEvent->AlmServoAxis10==1) data32 |= 0x0200;

	if(psDSPPacketOut_InfoEvent->AlmServoAxis11==1) data32 |= 0x0400;
	if(psDSPPacketOut_InfoEvent->AlmServoAxis12==1) data32 |= 0x0800;
	if(psDSPPacketOut_InfoEvent->AlmServoAxis13==1) data32 |= 0x01000;
	if(psDSPPacketOut_InfoEvent->AlmServoAxis14==1) data32 |= 0x02000;
	if(psDSPPacketOut_InfoEvent->AlmServoAxis15==1) data32 |= 0x04000;

	if(psDSPPacketOut_InfoEvent->AlmServoAxis16==1) data32 |= 0x08000;
	if(psDSPPacketOut_InfoEvent->AlmServoAxis17==1) data32 |= 0x010000;
	if(psDSPPacketOut_InfoEvent->AlmServoAxis18==1) data32 |= 0x020000;
	if(psDSPPacketOut_InfoEvent->AlmServoAxis19==1) data32 |= 0x040000;
	if(psDSPPacketOut_InfoEvent->AlmServoAxis20==1) data32 |= 0x080000;

	if(psDSPPacketOut_InfoEvent->AlmServoAxis21==1) data32 |= 0x0100000;
	if(psDSPPacketOut_InfoEvent->AlmServoAxis22==1) data32 |= 0x0200000;
	if(psDSPPacketOut_InfoEvent->AlmServoAxis23==1) data32 |= 0x0400000;
	*SendUUint32Pointer1++ = data32;

	data32 = 0;
	//data32 = 0xFFFFFFFF;//for test
	if(psDSPPacketOut_InfoEvent->AlmEncoderAxis1==1) data32 |= 0x01;
	if(psDSPPacketOut_InfoEvent->AlmEncoderAxis2==1) data32 |= 0x02;
	if(psDSPPacketOut_InfoEvent->AlmEncoderAxis3==1) data32 |= 0x04;
	if(psDSPPacketOut_InfoEvent->AlmEncoderAxis4==1) data32 |= 0x08;
	if(psDSPPacketOut_InfoEvent->AlmEncoderAxis5==1) data32 |= 0x010;

	if(psDSPPacketOut_InfoEvent->AlmEncoderAxis6==1) data32 |= 0x020;
	if(psDSPPacketOut_InfoEvent->AlmEncoderAxis7==1) data32 |= 0x040;
	if(psDSPPacketOut_InfoEvent->AlmEncoderAxis8==1) data32 |= 0x080;
	if(psDSPPacketOut_InfoEvent->AlmEncoderAxis9==1) data32 |= 0x0100;
	if(psDSPPacketOut_InfoEvent->AlmEncoderAxis10==1) data32 |= 0x0200;

	if(psDSPPacketOut_InfoEvent->AlmEncoderAxis11==1) data32 |= 0x0400;
	if(psDSPPacketOut_InfoEvent->AlmEncoderAxis12==1) data32 |= 0x0800;
	if(psDSPPacketOut_InfoEvent->AlmEncoderAxis13==1) data32 |= 0x01000;
	if(psDSPPacketOut_InfoEvent->AlmEncoderAxis14==1) data32 |= 0x02000;
	if(psDSPPacketOut_InfoEvent->AlmEncoderAxis15==1) data32 |= 0x04000;

	if(psDSPPacketOut_InfoEvent->AlmEncoderAxis16==1) data32 |= 0x08000;
	if(psDSPPacketOut_InfoEvent->AlmEncoderAxis17==1) data32 |= 0x010000;
	if(psDSPPacketOut_InfoEvent->AlmEncoderAxis18==1) data32 |= 0x020000;
	if(psDSPPacketOut_InfoEvent->AlmEncoderAxis19==1) data32 |= 0x040000;
	if(psDSPPacketOut_InfoEvent->AlmEncoderAxis20==1) data32 |= 0x080000;

	if(psDSPPacketOut_InfoEvent->AlmEncoderAxis21==1) data32 |= 0x0100000;
	if(psDSPPacketOut_InfoEvent->AlmEncoderAxis22==1) data32 |= 0x0200000;
	if(psDSPPacketOut_InfoEvent->AlmEncoderAxis23==1) data32 |= 0x0400000;
	*SendUUint32Pointer1++ = data32;

	//data32 = 0;
	//data32 = 12345;//for test
	*SendUUint32Pointer1++ = psDSPPacketOut->IOInInfo1;//GPIOIN1
	*SendUUint32Pointer1++ = psDSPPacketOut->IOInInfo2;//GPIOIN2
	*SendUUint32Pointer1++ = psDSPPacketOut->IOOutInfo1;//GPIOOUT1
	*SendUUint32Pointer1++ = psDSPPacketOut->IOOutInfo2;//GPIOOUT2
	*SendUUint32Pointer1++ = psDSPPacketOut->MainCmd1;//MainCmd1
	*SendUUint32Pointer1++ = psDSPPacketOut->MainCmd2;//MainCmd2
	*SendUUint32Pointer1++ = psDSPPacketOut->MainStatus1;//MainStatus1
	*SendUUint32Pointer1++ = psDSPPacketOut->MainStatus2;//MainStatus2

	data32 = 0;
	//data32 = 0xAAAAAAAA;//for test
	if(psDSPPacketOut_InfoEvent->SLimitPosAxis1==1) data32 |= 0x01;
	if(psDSPPacketOut_InfoEvent->SLimitPosAxis2==1) data32 |= 0x02;
	if(psDSPPacketOut_InfoEvent->SLimitPosAxis3==1) data32 |= 0x04;
	if(psDSPPacketOut_InfoEvent->SLimitPosAxis4==1) data32 |= 0x08;
	if(psDSPPacketOut_InfoEvent->SLimitPosAxis5==1) data32 |= 0x010;

	if(psDSPPacketOut_InfoEvent->SLimitPosAxis6==1) data32 |= 0x020;
	if(psDSPPacketOut_InfoEvent->SLimitPosAxis7==1) data32 |= 0x040;
	if(psDSPPacketOut_InfoEvent->SLimitPosAxis8==1) data32 |= 0x080;
	if(psDSPPacketOut_InfoEvent->SLimitPosAxis9==1) data32 |= 0x0100;
	if(psDSPPacketOut_InfoEvent->SLimitPosAxis10==1) data32 |= 0x0200;

	if(psDSPPacketOut_InfoEvent->SLimitPosAxis11==1) data32 |= 0x0400;
	if(psDSPPacketOut_InfoEvent->SLimitPosAxis12==1) data32 |= 0x0800;
	if(psDSPPacketOut_InfoEvent->SLimitPosAxis13==1) data32 |= 0x01000;
	if(psDSPPacketOut_InfoEvent->SLimitPosAxis14==1) data32 |= 0x02000;
	if(psDSPPacketOut_InfoEvent->SLimitPosAxis15==1) data32 |= 0x04000;

	if(psDSPPacketOut_InfoEvent->SLimitPosAxis16==1) data32 |= 0x08000;
	if(psDSPPacketOut_InfoEvent->SLimitPosAxis17==1) data32 |= 0x010000;
	if(psDSPPacketOut_InfoEvent->SLimitPosAxis18==1) data32 |= 0x020000;
	if(psDSPPacketOut_InfoEvent->SLimitPosAxis19==1) data32 |= 0x040000;
	if(psDSPPacketOut_InfoEvent->SLimitPosAxis20==1) data32 |= 0x080000;

	if(psDSPPacketOut_InfoEvent->SLimitPosAxis21==1) data32 |= 0x0100000;
	if(psDSPPacketOut_InfoEvent->SLimitPosAxis22==1) data32 |= 0x0200000;
	if(psDSPPacketOut_InfoEvent->SLimitPosAxis23==1) data32 |= 0x0400000;
	*SendUUint32Pointer1++ = data32;
	//printf("SLimitPos= 0x%x!\n",data32);

	data32 = 0;
	//data32 = 0xBBBBBBBB;//for test
	if(psDSPPacketOut_InfoEvent->SLimitNegAxis1==1) data32 |= 0x01;
	if(psDSPPacketOut_InfoEvent->SLimitNegAxis2==1) data32 |= 0x02;
	if(psDSPPacketOut_InfoEvent->SLimitNegAxis3==1) data32 |= 0x04;
	if(psDSPPacketOut_InfoEvent->SLimitNegAxis4==1) data32 |= 0x08;
	if(psDSPPacketOut_InfoEvent->SLimitNegAxis5==1) data32 |= 0x010;

	if(psDSPPacketOut_InfoEvent->SLimitNegAxis6==1) data32 |= 0x020;
	if(psDSPPacketOut_InfoEvent->SLimitNegAxis7==1) data32 |= 0x040;
	if(psDSPPacketOut_InfoEvent->SLimitNegAxis8==1) data32 |= 0x080;
	if(psDSPPacketOut_InfoEvent->SLimitNegAxis9==1) data32 |= 0x0100;
	if(psDSPPacketOut_InfoEvent->SLimitNegAxis10==1) data32 |= 0x0200;

	if(psDSPPacketOut_InfoEvent->SLimitNegAxis11==1) data32 |= 0x0400;
	if(psDSPPacketOut_InfoEvent->SLimitNegAxis12==1) data32 |= 0x0800;
	if(psDSPPacketOut_InfoEvent->SLimitNegAxis13==1) data32 |= 0x01000;
	if(psDSPPacketOut_InfoEvent->SLimitNegAxis14==1) data32 |= 0x02000;
	if(psDSPPacketOut_InfoEvent->SLimitNegAxis15==1) data32 |= 0x04000;

	if(psDSPPacketOut_InfoEvent->SLimitNegAxis16==1) data32 |= 0x08000;
	if(psDSPPacketOut_InfoEvent->SLimitNegAxis17==1) data32 |= 0x010000;
	if(psDSPPacketOut_InfoEvent->SLimitNegAxis18==1) data32 |= 0x020000;
	if(psDSPPacketOut_InfoEvent->SLimitNegAxis19==1) data32 |= 0x040000;
	if(psDSPPacketOut_InfoEvent->SLimitNegAxis20==1) data32 |= 0x080000;

	if(psDSPPacketOut_InfoEvent->SLimitNegAxis21==1) data32 |= 0x0100000;
	if(psDSPPacketOut_InfoEvent->SLimitNegAxis22==1) data32 |= 0x0200000;
	if(psDSPPacketOut_InfoEvent->SLimitNegAxis23==1) data32 |= 0x0400000;
	*SendUUint32Pointer1++ = data32;
	//printf("SLimitNeg= 0x%x!\n",data32);


	*SendUUint32Pointer1++ = psDSPPacketOut->TrackRunOver;//TrackRunOver
	*SendUUint32Pointer1++ = psDSPPacketOut->InterpolationOver;//InterpolationOver
	*SendUUint32Pointer1++ = psDSPPacketOut->CompensationDataCheckError;//CompensationDataCheckError
	data32 = 0;
	*SendUUint32Pointer1++ = data32;//reserved
	data32 = 0;
	*SendUUint32Pointer1++ = data32;//reserved
	...
	*SendUUint32Pointer1++ = data32;//reserved
	data32 = 0;
	*SendUUint32Pointer1++ = psDSPPacketOut->PacketCheckCodeBuf[5];//PacketCheckCodeBuf_B5

	*SendUUint32Pointer1++ = psDSPPacketOut->PacketCheckCodeBuf[4];//PacketCheckCodeBuf_B4
	*SendUUint32Pointer1++ = psDSPPacketOut->PacketCheckCodeBuf[3];//PacketCheckCodeBuf_B3
	*SendUUint32Pointer1++ = psDSPPacketOut->PacketCheckCodeBuf[2];//PacketCheckCodeBuf_B2
	*SendUUint32Pointer1++ = psDSPPacketOut->PacketCheckCodeBuf[1];//PacketCheckCodeBuf_B1
	*SendUUint32Pointer1++ = psDSPPacketOut->PacketCheckCodeBuf[0];//PacketCheckCodeBuf_B0

	CheckCode = crc32(SCIB_TxBuf,length_B0Back);		//length=124+7-1=131-1
	*SendUUint32Pointer1++ = CheckCode; 		//
	*SendUUint32Pointer1++ = 0; 				//sendcount

	*SendUUint32Pointer1++ = 0xbb;				//
	int i;
	for(i=0;i<=(length_B0Back+3);i++)
	{
		//STM32_TxBuf[i]= htonl(SCIB_TxBuf[i]);
		//printf("B0_send_buffer buff[%d]= 0x%x!\n",i,B0_send_buffer[i]);
	}

	STM32_TxTotal = (length_B0Back+4)*4;

	memcpy(STM32_TxBuf,SCIB_TxBuf,STM32_TxTotal);
}


Uint16 Dsp_Com_STM32(void) 
{	
	static Uint32 computerdata;
	static Uint8	FIFO_Clear_Sign=0;

	STM32_TxRXCounter++;
	if(STM32_TxRXCounter%3000 != 0)
	{
		return;
	}
	...
	if(1)
	{	//Send
		Dsp_Com_STM32_BackCMD_B0();

		STM32_TxIndex= 0;	
		STM32_RxIndex= 0;

		if(FIFO_Clear_Sign != 0)
		{
			if(FIFO_Clear_Sign & 0x01)
			{
				* STM32_IN_FIFO_Clear	= 0;	//W 0x954 stmÊäÈëFIFOÇå¿Õ 0Î»ÓÐÐ§ Ð´1´Î0Çå¿Õ
			}
			if(FIFO_Clear_Sign & 0x02)
			{
				* STM32_IN_FIFO_Clear	= 0x01;
			}
		}
		
		//STM32_TxTotal = 20; //for test
		while(STM32_TxIndex<STM32_TxTotal)
		{
			* WRITE_STM32_Data = STM32_TxBuf[STM32_TxIndex++];
		}

		if(STM32_TxIndex>=STM32_TxTotal)
		{	//·¢ÍêÊý¾Ý
			STM32_TxIndex = STM32_TxIndex;
		}
...
void Dsp_Com(void) 
{
	...
	if (psSHMEvent->EepromARM) 
	{
		...
		//tan_i = atandp(tan_i);
		#if 0
		Int32* ptr = (Int32*)psParaArm_Ctrl;
		Uint32 i = 0;

		if(psDSPPacketOut_InfoEvent->ParameterWriteCompleteSign ==true)
		{
			for(i=0; i<40; i++)
			{
				Log_info3("B1[%d] = 0x%x, %d\n", i, *ptr, *ptr++);
			}
		}
		#endif
	}
